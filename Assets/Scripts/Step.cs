...
public class Step
{
    ...
    [Header("Common")] [Tooltip("給 LockMovement/ToggleObject/SetFlag 等需要 bool 的步驟")]
    public bool boolValue;

    [Tooltip("Wait 秒數")] public float seconds = 1f;
    [Tooltip("任務文字 / 提示文字")] [TextArea] public string text;

    [Header("Dialogue")] public TextAsset inkJSON; // 對話腳本
    public Animator emoteAnimator; // 可選（表情/動作動畫）
    public bool lockMoveDuringDialogue = true;

    [Header("Cutscene")] public PlayableDirector director; // 直接拖場景裡的 Director
